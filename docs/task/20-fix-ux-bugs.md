...
- [x] Bug 1: 로그인 비밀번호 Enter 키 submit
- [x] Bug 2: 안읽음 뱃지 채팅방 진입 시 리셋
- [x] Fix 3: 스크롤 중 메시지 입력 단축키 (Escape)
- [x] Fix 4: 메시지 전송 후 최하단 자동 스크롤
- [x] Feat 5: 채팅방 나가기 (목록에서 제거)
- [x] Feat 6: 채팅방 삭제
- [x] Feat 7: 비어있는 화면 대응 (Empty State UI)
